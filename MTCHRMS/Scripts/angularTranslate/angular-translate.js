...
angular.module('pascalprecht.translate').provider('$translate', ['$STORAGE_KEY', function ($STORAGE_KEY) {
 ...
 /**
  ...
  this.useStaticFilesLoader = function (options) {
      console.log("useStaticFilesLoader : " + options);
  ...
  this.useLocalStorage = function () {
      ...
      return this.useStorage('localStorageService');        // I Syed Rahman Bokhari customize it to use my existing storage service
